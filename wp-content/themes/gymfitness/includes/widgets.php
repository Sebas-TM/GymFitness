...
?>
	...
	?>
		...
		<p>
			...
			<input class="widefat" type="number" id="<?php echo esc_attr($this->get_field_id('cantidad')) ?>" name="<?php echo esc_attr($this->get_field_name('cantidad')) ?>" value="<?php echo esc_attr($cantidad) ?>" />
		</p>
